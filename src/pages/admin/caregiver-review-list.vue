  ...
  <view class="review-list">
    ...
    >
      ...
      <view
        ...
        class="review-item"
        @tap="goToDetail(item.caregiverId)"
      >
        <view class="item-header">
          <view class="caregiver-info">
            <text class="caregiver-name">{{ item.caregiverName }}</text>
            <text class="caregiver-skills">{{ item.skills || '暂无技能' }}</text>
          </view>
        ...
        <view class="item-body">
          <view class="info-row">
            ...
            <text class="info-value">{{ item.idCard || '暂无' }}</text>
          </view>
          <view class="info-row">
            <text class="info-label">服务区域：</text>
            <text class="info-value">{{ item.serviceArea || '暂无' }}</text>
          </view>
          <view class="info-row">
            <text class="info-label">从业年限：</text>
            <text class="info-value">{{ item.workYears ? item.workYears + '年' : '暂无' }}</text>
          </view>
          <view class="info-row">
...
// 审核列表
const reviewList = computed(() => adminStore.caregiverReviewList)
const totalCount = computed(() => adminStore.caregiverReviewTotal)
...
async function loadData(isRefresh = false) {
  ...
  try {
    await adminStore.fetchCaregiverReviewList({
...
function goToDetail(id) {
  uni.navigateTo({
    url: `/pages/admin/caregiver-review-detail?id=${id}`,
  })
}
