  ...
  <view class="review-list">
    ...
    >
      ...
      <view
        ...
        :key="item.merchantId"
        class="review-item"
        @tap="goToDetail(item.merchantId)"
      >
        <view class="item-header">
          <view class="merchant-info">
            <text class="merchant-name">{{ item.merchantName }}</text>
            <text class="merchant-contact">{{ item.contactPerson }} · {{ item.contactPhone }}</text>
          </view>
        ...
        <view class="item-body">
          <view class="info-row">
            ...
            <text class="info-value">{{ item.businessLicense }}</text>
          </view>
          <view class="info-row">
...
// 审核列表
const reviewList = computed(() => adminStore.merchantReviewList)
const totalCount = computed(() => adminStore.merchantReviewTotal)
...
async function loadData(isRefresh = false) {
  ...
  try {
    await adminStore.fetchMerchantReviewList({
...
function goToDetail(id) {
  uni.navigateTo({
    url: `/pages/admin/merchant-review-detail?id=${id}`,
  })
}
